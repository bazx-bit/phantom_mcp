...
- [x] **Tab management.** Support multiple tabs with `ghost_tab_open()`, `ghost_tab_switch()`, `ghost_tab_close()`.
...
- [x] **Copy Critic.** Conversion-focused copy auditing persona.

## v1.3 — Phantom Forge (Phase 3)

- [ ] **Kinetic DNA Synthesis.** AI-driven generation of GSAP/Framer Motion code based on extracted DNA.
- [ ] **3D Asset Ripper.** Automated extraction of GLB/GLTF models and Three.js states.
- [ ] **Agentic Freedom mode.** Autonomous crawling and issue fixing without human intervention.
